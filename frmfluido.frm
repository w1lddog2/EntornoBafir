...
sPathBase = "\\Servidor2\e\EntornoBafir\partidas de compuesto.mdb"
    ...
    With cnn
        ...
        .ConnectionString = "provider=Microsoft.Jet.OLEDB.4.0;" & "Data Source=" & sPathBase & ";" & "Jet OLEDB:Database Password=zZz999;"
        .Open
    End With
...
If Option1.Value = True Then
    ...
    Set db = OpenDatabase("\\Servidor2\e\EntornoBafir\partidas de compuesto.mdb", False, False, ";pwd=zZz999")
    ...
    Set rs1 = db.OpenRecordset("SELECT codigo, valmasa, valagua1, valagua2, valagua3 FROM fluido_temp")
    rs.AddNew
...
Else
    ...
    Set db = OpenDatabase("\\Servidor2\e\EntornoBafir\partidas de compuesto.mdb", False, False, ";pwd=zZz999")
    Set rs = db.OpenRecordset("SELECT var_masa,codigo, n_formula, partida, tiemp_temp_oil, var_vol, var_tracc, var_elong, var_dur, fecha_realizacion, tiempo_repeticion, aprovado FROM fluidos where codigo = " & Text9.Text & "")
    Set rs1 = db.OpenRecordset("SELECT codigo, valmasa, valagua1, valagua2, valagua3 FROM fluido_temp where codigo = '" & Text9.Text & "'")
    ...
    If Text2.Text <> "" Then
    sadfsdf = MsgBox("La variación de volumen del ensayo es de " & vv & "." & "Desea ingresar las variaciones de tracción, elongación y dureza?", vbInformation + vbYesNo, "Carga de datos")
    Else
    sadfsdf = MsgBox("La variación de masa del ensayo es de " & vmasa & "." & "Desea ingresar las variaciones de tracción, elongación y dureza?", vbInformation + vbYesNo, "Carga de datos")
    End If
...
Set db = OpenDatabase("\\Servidor2\e\EntornoBafir\partidas de compuesto.mdb", False, True, ";pwd=zZz999")
